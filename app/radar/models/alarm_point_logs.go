...
type AlarmPointLogs struct {
	...
	OperatorId    int64      `json:"operatorId"     gorm:"default:0;comment:操作人ID"`
	Processed     int64      `json:"processed"      gorm:"type:tinyint;default:0;comment:是否处理完成"`
	ProcessRemark string     `json:"processRemark"  gorm:"size:255;comment:处理备注"`
