...
type RadarAlarmConfig struct {
	...
	RadarAlarmRuleId int64           `json:"radarAlarmRuleId" gorm:"uniqueIndex:uniq_deptid_tyle_ruleid;  comment:预警规则ID"`              //预警规则ID
...
func (RadarAlarmConfig) TableName() string {
	return "alarm_config"
}
